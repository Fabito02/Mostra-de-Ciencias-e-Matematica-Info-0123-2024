let pampas = {
  "Qual é o bioma que cobre o sul do Brasil, Uruguai e partes da Argentina?":
    "Pampas",
  ...
  "Em que estação os Pampas experimentam a maior quantidade de chuva?":
    "Primavera e verão",
...
let caatinga = {
  "Qual é o bioma exclusivo do Brasil que é conhecido por sua vegetação xerófila?":
    "Caatinga",
  ...
  "Qual é o principal animal de grande porte encontrado na Caatinga?":
    "Onça-Parda",
  "Qual é o principal tipo de vegetação encontrada na Caatinga?": "Xerófila",
  "Qual é a característica principal das chuvas na Caatinga?":
    "Irregulares e concentradas no verão",
  "Qual é um dos principais arbustos da Caatinga?": "Mandacaru",
  "Qual animal é frequentemente encontrado na Caatinga e está ameaçado de extinção?":
    "Tatu-bola",
  "Qual é o impacto das secas prolongadas na Caatinga?":
    "Redução da vegetação e escassez de água",
};
...
let pantanal = {
  ...
  "Qual é a principal característica da flora do Pantanal?":
    "Vegetação alagada e áreas inundáveis",
  "Qual é o maior predador do Pantanal?": "Onça-pintada",
  "Qual é um dos principais recursos naturais do Pantanal?":
    "Recursos pesqueiros",
  "Durante qual estação o Pantanal experimenta mais enchentes?":
    "Estação chuvosa (verão)",
  "Qual é uma das principais atividades econômicas no Pantanal?":
    "Pecuária de gado",
};

let mataAtlantica = {
  "Qual é o bioma que cobre a faixa litorânea do Brasil, do Nordeste ao Sul?":
    "Mata Atlântica",
  "Qual é a árvore símbolo da Mata Atlântica?": "Pau-brasil",
  "Qual é a principal característica do clima da Mata Atlântica?":
    "Tropical úmido",
  "Quantas espécies de fauna foram identificadas na Mata Atlântica?":
    "Mais de 1.000",
  "Qual é a principal ameaça à Mata Atlântica?": "Desmatamento",
  "Qual é o principal tipo de vegetação da Mata Atlântica?":
    "Floresta tropical úmida",
  "Qual é uma das principais ameaças à biodiversidade da Mata Atlântica?":
    "Desmatamento e urbanização",
  "Qual é um dos animais endêmicos da Mata Atlântica?":
    "Muriqui (ou mono-barrigudo)",
  "Qual é o impacto do turismo na Mata Atlântica?":
    "Pode causar degradação ambiental se não for sustentável",
  "Qual é o papel da Mata Atlântica no ciclo da água?":
    "Regulação do ciclo hídrico e manutenção da umidade",
};
...
let cerrado = {
  ...
  "Quantas espécies de plantas nativas o Cerrado abriga, aproximadamente?":
    "10.000",
  "Qual é o período de maior intensidade de queimadas no Cerrado?":
    "Período seco (inverno)",
  "Qual é uma das principais adaptações das plantas do Cerrado ao fogo?":
    "Resiliência e regeneração rápida",
  "Qual é um dos principais grupos de animais encontrados no Cerrado?":
    "Mamíferos como o lobo-guará",
  "Qual é a característica do solo do Cerrado?":
...
let florestaAmazonica = {
  ...
  "Qual é a principal árvore encontrada na Floresta Amazônica?":
    "Angelim-vermelho",
  "Qual é a característica climática predominante na Floresta Amazônica?":
    "Equatorial",
  "Quantas espécies de árvores existem, aproximadamente, na Floresta Amazônica?":
    "Mais de 16.000",
  "Qual é o principal fator que contribui para a alta biodiversidade da Floresta Amazônica?":
    "Clima quente e úmido",
  "Qual é a principal vegetação encontrada na Floresta Amazônica?":
    "Floresta tropical densa",
  "Qual é o impacto da desflorestação na Floresta Amazônica?":
    "Perda de biodiversidade e alterações climáticas",
  "Qual é o nome do fenômeno de redução da umidade na Floresta Amazônica devido à destruição da vegetação?":
    "Desertificação",
  "Qual é o papel das árvores na Floresta Amazônica para a atmosfera?":
    "Absorvem dióxido de carbono e liberam oxigênio",
};
...
function encontrarRespostasErradas(
  vetorTotalRespostas,
  vetorRespostasselecionada
) {
  let vetorAltErradas = [];
...
let vetorErradas = encontrarRespostasErradas(
  vetorTotalRespostas,
  vetorCorretas
);
...
function fimQuiz(vetor) {
  ...
  pontuacaoFinalAmazonia.innerText =
    "Acertos: " + pontosFlorestaAmazonia + "/2";
