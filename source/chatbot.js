...
async function mandar_mensagem(msg) {
    ...
    carregarMensagemChatbot(text, `https://raw.githubusercontent.com/Luckikinhas/Chat-bot/main/question.gif`);
    contadorMensagens++
    }
    else{
    carregarMensagemChatbot(text, `https://raw.githubusercontent.com/Luckikinhas/Chat-bot/main/question.gif`);
...
function carregarMensagemChatbot(resposta, sourceIcone){
    ...
    iconeBotCarregamento.src='https://raw.githubusercontent.com/Luckikinhas/Chat-bot/main/loading.gif';
    pontos.classList.add('animacao3Pontos')
    pontos.src='https://raw.githubusercontent.com/Luckikinhas/Chat-bot/main/animação%20de%20loading.gif'
